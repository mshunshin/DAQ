...
class LaserGui(QtWidgets.QWidget):
    ...
    def __init__(self, laser_exp, parent=None):
    ...
    def setup_gui(self):
        ...
        self.cranial1_toggle = QtWidgets.QCheckBox("View Cranial1")
        self.cranial1_toggle.stateChanged.connect(self.cranial1_toggle_changed)

        self.cranial2_toggle = QtWidgets.QCheckBox("View Cranial2")
        ...
        self.cranial1_pi.setLabel(axis='left',text="TCD")
        ...
        self.cranial2_pi.setLabel(axis='left',text="TCD")
    ...
    def update_data(self):
        ...
        self.pressure_plt.setData(x=np.arange(samples), y=self.laser_exp.pressure.data, pen='k', antialise=True, autoDownsample=True, clipToView=True)
        ...
        self.laser1_plt.setData(x=np.arange(samples), y=laser1_data, pen='k', antialise=True, autoDownsample=True, clipToView=True)
        self.laser2_plt.setData(x=np.arange(samples), y=laser2_data, pen='k', antialise=True, autoDownsample=True, clipToView=True)
        ...
        self.ecg_plt.setData(x=np.arange(samples), y=self.laser_exp.ecg.data, pen='k', symbol=None, antialise=True, autoDownsample=True, clipToView=True)
